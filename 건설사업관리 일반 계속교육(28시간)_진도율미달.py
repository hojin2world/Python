...
def get_configured_driver(download_directory):
    ...
    file_name = f"{today_date}_건설사업관리 일반 계속교육(28시간) [토목 · 도시교통 · 안전관리] 특급 패키지 1_진도율미만.xlsx"
...
selectbox = Select(driver.find_element(By.XPATH,'//*[@id="wrapper"]/div[1]/div/div/div[1]/div[2]/div/table/tbody/tr[6]/td[2]/div/div[2]/select')) #진도율
selectbox.select_by_value('90') #90 선택
time.sleep(1)
...
new_file_path = downloaded_file_path.replace('download.xls', f'{today_date}_건설사업관리 일반 계속교육(28시간) [토목 · 도시교통 · 안전관리] 특급 패키지 1_진도율.xlsx')
...
# 변경 후 파일 경로
new_file_path = os.path.join(download_directory, f'{today_date}_건설사업관리 일반 계속교육(28시간) [토목 · 도시교통 · 안전관리] 특급 패키지 1_진도율.xlsx')
...
# 엑셀 파일 경로
excel_file = os.path.join(download_directory, f'{today_date}_건설사업관리 일반 계속교육(28시간) [토목 · 도시교통 · 안전관리] 특급 패키지 1_진도율.xlsx')
...
new_excel_file = rf'{download_directory}\{today_date}_뿌리오_건설사업관리 일반 계속교육(28시간) [토목 · 도시교통 · 안전관리] 특급 패키지 1_진도율.xlsx'
...
현 시점 기준 교육종료일까지 수료조건을 모두 만족할 수 있는지 일정 확인하시기 바랍니다.
...
# 파일 경로 설정
file_path = rf"C:\Users\user\Downloads\python\{today_date}_뿌리오_건설사업관리 일반 계속교육(28시간) [토목 · 도시교통 · 안전관리] 특급 패키지 1_진도율.xlsx"
print(file_input)
print(file_path)
