...
def get_configured_driver(download_directory):
    ...
    file_name = f"{today_date}_건설사업관리16시간_과제미제출.xlsx"
...
selectbox.select_by_value('0') #90 선택
time.sleep(1)
...
new_file_path = downloaded_file_path.replace('download.xls', f'{today_date}_건설사업관리16시간과제미제출.xlsx')
...
# 변경 후 파일 경로
new_file_path = os.path.join(download_directory, f'{today_date}_건설사업관리16시간과제미제출.xlsx')
...
# 엑셀 파일 경로
excel_file = os.path.join(download_directory, f'{today_date}_건설사업관리16시간과제미제출.xlsx')
...
new_excel_file = rf'{download_directory}\{today_date}_뿌리오_건설사업관리16시간과제미제출.xlsx'
...
# 파일 경로 설정
file_path = rf"C:\Users\user\Downloads\python\{today_date}_뿌리오_건설사업관리16시간과제미제출.xlsx"
print(file_input)
print(file_path)
